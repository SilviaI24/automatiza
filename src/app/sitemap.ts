...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${base}/sectores/administracion-de-fincas`,              lastModified: "2026-08-04", changeFrequency: "monthly", priority: 0.8  },
    { url: `${base}/sectores/inmobiliarias`,                         lastModified: "2026-07-30", changeFrequency: "monthly", priority: 0.8  },
    { url: `${base}/sectores/bufetes-abogados`,                      lastModified: "2026-07-30", changeFrequency: "monthly", priority: 0.8  },
    { url: `${base}/sectores/empresas-mantenimiento`,                lastModified: "2026-07-30", changeFrequency: "monthly", priority: 0.8  },
    { url: `${base}/sectores/clinicas-centros-salud`,                lastModified: "2026-07-30", changeFrequency: "monthly", priority: 0.8  },
